...
/**
 * This class implements a special kind of options' values. Options' values of
 * this kind are comma separated lists of values. For example:
 * "value1,value,value3".
 * 
 * @author Denis BEURIVE
 * @see args4j documentation.
 */
public class CommaSeparatedStripedListOptionHandler extends
	 ...
	 *            See documentation for Args4J.
	 */
	public CommaSeparatedStripedListOptionHandler(CmdLineParser parser,
			OptionDef option, Setter<? super String> setter) {
	 ...
	 * 
	 * @param in_parameters
	 *            List of strings that represents the parameters for the option.
